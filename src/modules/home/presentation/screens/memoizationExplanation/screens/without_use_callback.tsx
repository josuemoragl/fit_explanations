...
export default function WithoutUseCallbackScreen() {
  ...
  return (
    <View style={styles.main}>
      ...
      <Text>
        In this case page has a state counter state value, that's value changes
        2 seconds. We also have two more state values: start, end, those states
        ...
        range of two numbers, the start and end. Any nested child are using any
        memoization method, even if it's parent re-renders every 2 seconds, and
        the nested child three, that has a expensive function to implement on it
        is not memoized. This implies in a low performance screen. Every 2
        seconds nestes child 3 is making a expensive logic due the change of
        counter state
      </Text>
...
function NestedChildThree(props: any) {
